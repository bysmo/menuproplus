<div>
    ...
    @endif
        ...
        @if ($activePaymentSetting == 'paydunya')
            <form wire:submit="submitFormPaydunya" class="mt-4">
                <div class="grid gap-6">
                    <div class="my-3">
                        <x-label for="paydunya_status">
                            <div class="flex items-center cursor-pointer">
                                <x-checkbox name="paydunya_status" id="paydunya_status" wire:model.live="paydunya_status" />
                                <div class="ms-2">Activer PayDunya (Mobile Money)</div>
                            </div>
                        </x-label>
                    </div>
                    ...
                    @if ($paydunya_status)
                        <div>
                            <x-label for="paydunya_mode" :value="__('modules.settings.selectEnvironment')" required />
                            <x-select id="paydunya_mode" class="block w-full mt-1" wire:model.live="paydunya_mode">
                                <option value="test">@lang('app.test')</option>
                                <option value="live">@lang('app.live')</option>
                            </x-select>
                            <x-input-error for="paydunya_mode" class="mt-2" />
                        </div>

                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                <x-label for="paydunya_master_key" value="Master Key" />
                                <x-input-password id="paydunya_master_key" class="block w-full mt-1" wire:model="paydunya_master_key" />
                                <x-input-error for="paydunya_master_key" class="mt-2" />
                            </div>
                            <div>
                                <x-label for="paydunya_token" value="Token" />
                                <x-input-password id="paydunya_token" class="block w-full mt-1" wire:model="paydunya_token" />
                                <x-input-error for="paydunya_token" class="mt-2" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                ...
                                <x-input-password id="paydunya_private_key" class="block w-full mt-1" wire:model="paydunya_private_key" />
                                <x-input-error for="paydunya_private_key" class="mt-2" />
                            </div>
                            <div>
                                <x-label for="paydunya_public_key" value="Public Key" />
                                <x-input id="paydunya_public_key" class="block w-full mt-1" type="text" wire:model="paydunya_public_key" />
                                <x-input-error for="paydunya_public_key" class="mt-2" />
                            </div>
                        </div>

                        <div class="p-3 text-sm text-blue-700 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/20 dark:text-blue-300">
                            📱 PayDunya permet d'accepter les paiements via <strong>Orange Money, MTN Mobile Money, Moov Money</strong> et carte bancaire.
                            Obtenez vos clés sur <a href="https://paydunya.com" target="_blank" class="underline">paydunya.com</a>.
                        </div>
                    @endif

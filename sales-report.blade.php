<div>
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">@lang('menu.salesReport')</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <!-- Stats Cards -->
    <div class="grid grid-cols-1 gap-4 px-4 pt-4 xl:grid-cols-6 2xl:grid-cols-6">
            <!-- Total Sales Card -->
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-xs font-medium text-gray-600 dark:text-gray-400">@lang('modules.report.totalSales')</h3>

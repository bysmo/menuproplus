...
class Cart extends Component
{
    ...
    {
        $restaurantId = $this->restaurant->id ?? 'unknown';
        $branchId = $this->shopBranch->id ?? 'unknown';
        $tableId = $this->tableID ?? 'notable';
        $customerId = customer() ? customer()->id : 'guest';

        return "cart_{$restaurantId}_{$branchId}_{$tableId}_{$customerId}";
    }
    ...
    public function mount()
    {
        ...
        // 🔥 NOUVEAU : Charger le panier existant depuis la session
        $this->loadCartFromSession();
    }
    ...
    public function setCustomerLocation($lat = null, $lng = null, $address = null)
    {
        ...
        // 🔥 NOUVEAU : Sauvegarder la vidange en session
    ...
    public function addQty($id)
    {
        ...
        // 🔥 NOUVEAU : Sauvegarder en session
        $this->saveCartToSession();
    }
    ...
    public function placeOrder($pay = false, $updateOrder = null, $method = null)
    {
        ...
        if ($updateOrder) {
            ...
            // 🔥 NOUVEAU : Vider le panier après commande réussie
            $this->clearCart();

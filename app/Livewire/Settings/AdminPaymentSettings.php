...
{
    use LivewireAlert;
    public $gateways = ['stripe', 'razorpay', 'flutterwave', 'payfast', 'paypal', 'paystack', 'xendit', 'paydunya'];
    public array $gatewayLogos = [
        ...
        'paydunya' => '<svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="5" y="2" width="14" height="20" rx="2" stroke="#FF6B35" stroke-width="1.8"/>
                        <circle cx="12" cy="17" r="1" fill="#FF6B35"/>
                        <path d="M9 6h6M9 9h4" stroke="#FF6B35" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>',
    ];
    public $settings = [];

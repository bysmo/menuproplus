...
return [
    ...
    'table' => [
        ...
        'customizeQrCode' => 'Customize QR Codes',
        'customizeQrCodeDesc' => 'Design the style applied to all your restaurant\'s QR codes',
        'qrColors' => 'Colors',
        'qrForegroundColor' => 'QR Color (Body)',
        'qrBackgroundColor' => 'Background',
        'qrColorPresets' => 'Color Presets',
        'qrEyeStyling' => 'Corner Eyes (Finder Patterns)',
        'qrEyeShape' => 'Eye Shape',
        'qrEyeSquare' => 'Classic Square',
        'qrEyeRounded' => 'Modern Rounded',
        'qrEyeCircle' => 'Full Circle',
        'qrEyeLeaf' => 'Leaf / Drop',
        'qrEyeColor' => 'Eye Color',
        'qrSyncEyeColor' => 'Same color as QR body',
        'qrCustomEyeColor' => 'Custom eye color',
        'qrLogo' => 'Center Logo',
        'qrShowLogo' => 'Embed logo in center',
        'qrShowLogoDesc' => 'Integrates your logo in center of QR codes with high error correction',
        'qrUsingRestaurantLogo' => 'Current restaurant logo',
        'qrOrUploadCustom' => 'Or upload a custom QR logo',
        'qrCustomLogo' => 'Upload logo (PNG, JPG, WEBP)',
        'qrLogoSize' => 'Logo size',
        'qrRemoveCustomLogo' => 'Remove custom logo',
        'qrLabelText' => 'Text below QR',
        'qrLabelTextPlaceholder' => 'e.g. Scan to order',
        'qrLabelDefault' => 'Scan to order',
        'qrLabelPresets' => 'Text suggestions',
        'qrLabelColor' => 'Text color',
        'qrLabelSize' => 'Font size',
        'qrLabelFont' => 'Font family',
        'qrFontNotoSans' => 'Noto Sans',
        'qrFontOpenSans' => 'Open Sans',
        'qrPreview' => 'Live Preview',
        'qrPreviewLoading' => 'Generating preview...',
        'qrRefreshPreview' => 'Refresh preview',
        'qrReset' => 'Reset to defaults',
        'qrApplyAndRegenerate' => 'Save & Regenerate All QR Codes',
        'qrCustomizationSaved' => 'QR customization saved! All QR codes have been regenerated.',
    ...
    'customer' => [
        ...
        'walkin' => 'Walkin',
        'enjoyYourMeal' => 'Enjoy your meal at our restaurant',
        'getItDelivered' => 'Get it delivered to your doorstep',
        'orderAhead' => 'Order ahead and pick up later',
    ],
    ...
    'cashier' => [
        ...
        'noData' => 'No data available',
        'refund' => 'Refund',
        'refundOrderPrefix' => 'Refund order',
        'amountToRefund' => 'Amount to refund:',
        'refundReasonLabel' => 'Refund Reason',
        'refundReasonPlaceholder' => 'Please justify why you are refunding this order...',
        'refundWarningTitle' => 'Warning!',
        'refundWarningMessage' => 'This action will cancel the order and deduct the amount from the current cash session. This operation is irreversible.',
        ...
        'closedAt' => 'Closed at',
        'closeSession' => 'Close session',
        'closingAmounts' => 'Closing amounts',
        'closingNotes' => 'Closing notes',
        'closingNotesPlaceholder' => 'Enter your closing notes...',
        ...
        'justificationPlaceholder' => 'Enter a justification for the discrepancy...',
        'loading' => 'Loading...',
        'noActiveSession' => 'No active session',
        'noPendingPayments' => 'No pending payments',
        'noPreviousSession' => 'No previous session',
        ...
        'onlyOwnerCanClose' => 'Only the session owner can close it',
        'onlySessionOwnerCanClose' => 'Only the session owner can close it',
        'openedAt' => 'Opened at',
        'openingBalance' => 'Opening balance',
        'openingDate' => 'Opening date',
        'openingTime' => 'Opening time',
        'openNewSession' => 'Open new session',
        'openNewSessionHelp' => 'Start a new cash session by indicating the initial fund.',
        'openSession' => 'Open session',
        'optional' => 'Optional',
        'order' => 'Order',
        'pending' => 'Pending',
        ...
        'validate' => 'Validate',
        'accountant' => 'Accountant',
        'balancedCashRegister' => 'Balanced cash register',
        'closed' => 'Closed',
        'closedBy' => 'Closed by',
        'closing' => 'Closing',
        'closingDate' => 'Closing date',
        'closingSlip' => 'Closing slip',
        'closingSlipSubtitle' => 'Cash register closing details',
        'confirmValidation' => 'Confirm validation',
        'detailsByMethod' => 'Details by method',
        'detailsByPaymentMethod' => 'Details by payment method',
        'discrepancy' => 'Discrepancy',
        'discrepancyJustification' => 'Discrepancy justification',
        'documentGeneratedAutomatically' => 'Document generated automatically',
        'expense' => 'Expense',
        'financialSummary' => 'Financial summary',
        'initialFund' => 'Initial fund',
        'justificationProvided' => 'Justification provided',
        ...
        'method' => 'Method',
        'mobile_money' => 'Mobile Money',
        'noDiscrepancyMessage' => 'No discrepancy reported during closing.',
        'noSessionFound' => 'No session found',
        'noSessionsToValidate' => 'No sessions to validate',
        'notesAndRemarks' => 'Notes and remarks',
        'noTransactions' => 'No transactions',
        'opened' => 'Opened',
        'openedBy' => 'Opened by',
        'opening' => 'Opening',
        'openingDetails' => 'Opening details',
        'openingSlip' => 'Opening slip',
        'openingSlipSubtitle' => 'Cash register opening details',
        'printClosing' => 'Print closing',
        'printOpening' => 'Print opening',
        'realBalance' => 'Real balance',
        'sale' => 'Sale',

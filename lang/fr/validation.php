...
return array (
    ...
    'can'                 => 'La valeur sélectionnée pour :attribute n’est pas autorisée.',
    ...
    'missing_with_all'    => 'Le champ :attribute doit être absent lorsque toutes les valeurs :values sont présentes.',
    ...
    'present_with_all'    => 'Le champ :attribute doit être présent lorsque toutes les valeurs :values sont présentes.',
    'prohibited'          => 'Le champ :attribute est interdit.',
    'prohibited_if'       => 'Le champ :attribute est interdit lorsque :other vaut :value.',
    'prohibited_unless'   => 'Le champ :attribute est interdit sauf si :other vaut l’une des valeurs :values.',
    ...
    'required_unless'     => 'Le champ :attribute est obligatoire sauf si :other vaut l’une des valeurs :values.',
    'required_with'       => 'Le champ :attribute est obligatoire lorsque :values est présent.',
    'required_with_all'   => 'Le champ :attribute est obligatoire lorsque toutes les valeurs :values sont présentes.',
    ...
    'variationNameRequired'      => 'Le nom de la variation est obligatoire.',
    'variationPriceRequired'     => 'Le prix de la variation est obligatoire.',
    'variationPriceNumeric'      => 'Le prix de la variation doit être un nombre.',
    'itemNameRequired'           => 'Le nom de l’élément est obligatoire pour la langue :language.',
    'menuNameRequired'           => 'Le nom du menu est obligatoire pour la langue :language.',
    'categoryNameRequired'       => 'Le nom de la catégorie est obligatoire pour la langue :language.',
    'categoryNameUnique'         => 'Le nom de la catégorie pour la langue :language est déjà utilisé.',
    'alreadyAssociatedGroup'     => 'Le groupe de modificateurs sélectionné est déjà associé à cet élément de menu.',
    'cannotRemoveTranslation'    => 'Impossible de supprimer la traduction pour :language.',
);